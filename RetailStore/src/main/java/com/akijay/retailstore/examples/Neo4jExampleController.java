...
public class Neo4jExampleController
{
	...
	String home()
	{
		return "Hello World From Neo4jExampleController";
	}
	...
	{
		SpringApplication.run(Neo4jExampleController.class, args);
